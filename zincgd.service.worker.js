...
/** @type {string} */
const CACHE_VERSION = '1753373583|10012351276';
/** @type {string} */
const CACHE_PREFIX = 'zincgd-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'zincgd.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = false;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["zincgd.html","zincgd.js","zincgd.offline.html","zincgd.icon.png","zincgd.apple-touch-icon.png","zincgd.audio.worklet.js","zincgd.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["zincgd.wasm","zincgd.pck","zincgd.side.wasm","crustzincgd.wasm"];
